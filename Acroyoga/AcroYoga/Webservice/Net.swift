...
//        Webservice.cancelRequestForKey(kMeRequestKey)
    ...
    class func requestUser() -> Future<Bool, NSError>
    {
        ...
        Webservice.request(AYNet.ACROYOGA_LOGIN, params: [ AYNet.USERFACEBOOKID: userID!, AYNet.USERNAME: username!, AYNet.USERMAINIMAGEURL: mainImageUrl! ], animated: true).onSuccess { (result: WebResult<AYResult>) -> Void in
